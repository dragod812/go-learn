...
var file_greet_greetpb_greet_proto_rawDesc = []byte{
	...
	0x32, 0x84, 0x02, 0x0a, 0x0c, 0x47, 0x72, 0x65, 0x65, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x30, 0x01, 0x12, 0x3b, 0x0a, 0x0a, 0x47, 0x72, 0x65, 0x65,
	0x74, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x12, 0x13, 0x2e, 0x67, 0x72, 0x65, 0x65, 0x74, 0x2e, 0x47,
	...
	0x65, 0x22, 0x00, 0x28, 0x01, 0x12, 0x40, 0x0a, 0x0d, 0x47, 0x72, 0x65, 0x65, 0x74, 0x45, 0x76,
	0x65, 0x72, 0x79, 0x6f, 0x6e, 0x65, 0x12, 0x13, 0x2e, 0x67, 0x72, 0x65, 0x65, 0x74, 0x2e, 0x47,
	0x72, 0x65, 0x65, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x14, 0x2e, 0x67, 0x72,
	0x65, 0x65, 0x74, 0x2e, 0x47, 0x72, 0x65, 0x65, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x22, 0x00, 0x28, 0x01, 0x30, 0x01, 0x42, 0x0f, 0x5a, 0x0d, 0x67, 0x72, 0x65, 0x65, 0x74,
...
var file_greet_greetpb_greet_proto_depIdxs = []int32{
	...
	1, // 3: greet.GreetService.GreetGroup:input_type -> greet.GreetRequest
	...
	2, // 7: greet.GreetService.GreetGroup:output_type -> greet.GreetResponse
...
type GreetServiceClient interface {
	...
	GreetGroup(ctx context.Context, opts ...grpc.CallOption) (GreetService_GreetGroupClient, error)
...
func (c *greetServiceClient) GreetGroup(ctx context.Context, opts ...grpc.CallOption) (GreetService_GreetGroupClient, error) {
	stream, err := c.cc.NewStream(ctx, &_GreetService_serviceDesc.Streams[1], "/greet.GreetService/GreetGroup", opts...)
	if err != nil {
		return nil, err
	}
	x := &greetServiceGreetGroupClient{stream}
	return x, nil
}

type GreetService_GreetGroupClient interface {
	Send(*GreetRequest) error
	CloseAndRecv() (*GreetResponse, error)
	grpc.ClientStream
}

type greetServiceGreetGroupClient struct {
	grpc.ClientStream
}

func (x *greetServiceGreetGroupClient) Send(m *GreetRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greetServiceGreetGroupClient) CloseAndRecv() (*GreetResponse, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(GreetResponse)
...
type GreetServiceServer interface {
	...
	// Client Side Streaming
	GreetGroup(GreetService_GreetGroupServer) error
	// Bi-Directional streaming
...
func (*UnimplementedGreetServiceServer) GreetGroup(GreetService_GreetGroupServer) error {
	return status.Errorf(codes.Unimplemented, "method GreetGroup not implemented")
}
...
func _GreetService_GreetGroup_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreetServiceServer).GreetGroup(&greetServiceGreetGroupServer{stream})
}

type GreetService_GreetGroupServer interface {
	SendAndClose(*GreetResponse) error
	Recv() (*GreetRequest, error)
	grpc.ServerStream
}

type greetServiceGreetGroupServer struct {
	grpc.ServerStream
}

func (x *greetServiceGreetGroupServer) SendAndClose(m *GreetResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greetServiceGreetGroupServer) Recv() (*GreetRequest, error) {
	m := new(GreetRequest)
